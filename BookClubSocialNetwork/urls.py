...
from BookClub.views.reviews import CreateReviewView
...
urlpatterns = [
    ...
    path('library/review/<int:book_id>', CreateReviewView.as_view(), name = 'create_review'), # create review for book represented by id
