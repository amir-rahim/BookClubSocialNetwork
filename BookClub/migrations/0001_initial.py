    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saved_booklists', models.ManyToManyField(blank=True, to='BookClub.BookList')),
        ...
        migrations.AddField(
            model_name='clubrecommendations',
            name='club',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recommendations', to='BookClub.club'),
        ),
        migrations.AddConstraint(
