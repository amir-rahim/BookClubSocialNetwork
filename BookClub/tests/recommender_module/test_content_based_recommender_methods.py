...
class ContentBasedRecommenderMethodsTestCase(TestCase):
    ...
    def test_get_recommendations_from_positive_ratings(self):
        ...
        recommendations = self.content_based_methods.get_recommendations_from_positive_ratings(self.positive_ratings, self.all_ratings)
    ...
    def test_get_recommendations_from_positive_ratings_does_not_contain_read_books(self):
        self.set_up_content_based_methods_from_csv()
        recommendations1 = self.content_based_methods.get_recommendations_from_positive_ratings(self.positive_ratings, self.all_ratings)
        book1 = recommendations1[0]
        self.assertTrue(book1 in recommendations1)
        self.all_ratings.append((book1, 1))
        recommendations2 = self.content_based_methods.get_recommendations_from_positive_ratings(self.positive_ratings, self.all_ratings)
    ...
    def test_get_recommendations_positive_ratings_only_from_user_id(self):
        self.set_up_content_based_methods_from_csv()
        recommendations1 = self.content_based_methods.get_recommendations_positive_ratings_only_from_user_id(self.user.username)
        positive_ratings = [
            ("014029192X", 7),
        ]
        all_ratings = [
        ...
        recommendations2 = self.content_based_methods.get_recommendations_from_positive_ratings(positive_ratings, all_ratings)
    ...
    def test_get_recommendations_positive_ratings_only_from_club_url_name(self):
        self.set_up_content_based_methods_from_csv()
        recommendations1 = self.content_based_methods.get_recommendations_positive_ratings_only_from_club_url_name(self.club.club_url_name)
        recommendations2 = self.content_based_methods.get_recommendations_from_positive_ratings(self.positive_ratings, self.all_ratings)
        self.assertEqual(recommendations1, recommendations2)
