...
class ContentBasedRecommender(AbstractRecommender):
    ...
    def fit(self, trainset=None, parameters={}):
        self.content_based_methods = ContentBasedRecommenderMethods(trainset=trainset, retraining=True)
    ...
    def fit_and_save(self, trainset=None, parameters={}):
        self.content_based_methods = ContentBasedRecommenderMethods(trainset=trainset, retraining_and_saving=True)
