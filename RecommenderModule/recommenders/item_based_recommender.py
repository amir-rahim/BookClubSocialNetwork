...
class ItemBasedRecommender(AbstractRecommender):
    ...
    def train(self, trainset=None, parameters={}):
        ItemBasedCollaborativeFilteringMethods(trainset=trainset, retraining=True, parameters=parameters)
    ...
    def train_and_save(self, trainset=None, parameters={}):
        ItemBasedCollaborativeFilteringMethods(trainset=trainset, retraining_and_saving=True, parameters=parameters)
